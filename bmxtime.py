...
class StartWindow(wx.Frame):
        ...
        def __init__(self, parent = None, id = -1, title = "BMX Bludenz - Zeitmessung"):
                ...
                #Filemenu - Port
                menuitem = filemenu2.Append(-1, "&Port", "Einstellungen für die Schnittstellen")
                self.Bind(wx.EVT_MENU, self.OnPortConfiguration, menuitem)

                #Filemenu 2 - Messsstellen
                menuitem = filemenu2.Append(-1, "&Messstellen", "Einstellungen für die Zwischenzeiten")
                ...
                # Buttons
                self.buttonadd = wx.Button(self.panel, -1, label='Hinzufügen', pos=(630,299))
